defmodule GameOfLifeElixir.CellTest do
  ...
  test "alive cell with no neighbours dies" do
    ...
    refute GameOfLifeElixir.Cell.keep_alive?(alive_cells, alive_cell)
  end
  ...
  test "alive cell with 2 neighbours lives" do
    ...
    assert GameOfLifeElixir.Cell.keep_alive?(alive_cells, alive_cell)
  end
  ...
  test "dead cell with three live neighbours becomes a live cell" do
    ...
    dead_cell = {1, 1}
    assert GameOfLifeElixir.Cell.become_alive?(alive_cells, dead_cell)
  end

  test "dead cell with two live neighbours stays dead" do
    alive_cells = [{2, 2}, {1, 0}]
    dead_cell = {1, 1}
    refute GameOfLifeElixir.Cell.become_alive?(alive_cells, dead_cell)
  end

  # dead_neighbours?
  test "find dead cells (neighbours of alive cell)" do
    alive_cells = [{1, 1}]
    dead_neighbours = GameOfLifeElixir.Cell.dead_neighbours(alive_cells) |> Enum.sort
