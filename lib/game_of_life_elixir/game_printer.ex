defmodule GameOfLifeElixir.GamePrinter do
  @moduledoc """
  ## Example
      iex> GameOfLifeElixir.GamePrinter.start_printing_board
      :printing_started
      iex> GameOfLifeElixir.GamePrinter.start_printing_board
      :already_printing
      iex> GameOfLifeElixir.GamePrinter.stop_printing_board
      :printing_stopped
      iex> GameOfLifeElixir.GamePrinter.stop_printing_board
      :already_stopped
  """
  ...
  def print_board do
    {alive_cells, generation_counter} = GameOfLifeElixir.BoardServer.state
    alive_counter = alive_cells |> Enum.count
    GameOfLifeElixir.Presenters.Console.print(alive_cells, generation_counter, alive_counter)
  end
